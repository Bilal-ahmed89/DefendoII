...
import { useGetTankTopsDetailsByIdQuery } from '../../../features/TankTops';
...
function TankTopsDescription() {

    const [selectedImage, setSelectedImage] = useState(null);
    const { id } = useParams();
    const { data: productData } = useGetTankTopsDetailsByIdQuery(id)
...
export default TankTopsDescription;