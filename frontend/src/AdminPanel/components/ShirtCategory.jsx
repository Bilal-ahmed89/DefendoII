...
import { useDeleteShirtsDetailsMutation, useGetShirtsDetailsQuery } from '../../features/shirts';
import ShirtProduct from '../All Products/ShirtProduct';
...
const ShirtCategory = () => {
    ...
    const { data } = useGetShirtsDetailsQuery();
    const [ deleteShirtDetailsMutation ] = useDeleteShirtsDetailsMutation();
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await deleteShirtDetailsMutation(id);
    ...
    return (
        <div className='p-2 container'>
            <h2 className='text-center mt-4'>Shirt Category</h2>
